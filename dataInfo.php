...
<head>
    ...
    <title>Data Info - Lead Express Admin Dashboard</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="php/updateDataInfo.php?dataId=<?php echo $dataId ?>" method="post" class="form">
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        <label for="full-name-column">Status</label>
                                                        <select name="status" id="status" class="form-control">
                                                            <option value="1" <?php if($row['status'] == 1){echo "selected";} ?>>Pending</option>
                                                            <option value="2" <?php if($row['status'] == 2){echo "selected";} ?>>Confirmed</option>
                                                            <option value="3" <?php if($row['status'] == 3){echo "selected";} ?>>Installed</option>
                                                            <option value="4" <?php if($row['status'] == 4){echo "selected";} ?>>Rescheduled</option>
                                                            <option value="5" <?php if($row['status'] == 5){echo "selected";} ?>>Cancelled</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        <label for="verifier-column">Verifier Comment</label>
                                                        <textarea class="form-control" id="verifier-column" rows="3" name="comment"><?php echo $row['verifierComment']?></textarea>
                                                    </div>
                                                </div>
